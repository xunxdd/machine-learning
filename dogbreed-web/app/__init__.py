...
app.config['MODEL_H5'] = basedir + '/model.h5'
app.config['CV2_CLASSIFIER'] = basedir + '/haarcascades/haarcascade_frontalface_alt.xml'
app.model = load_model(app.config['MODEL_H5'])
app.xception_model = Xception(weights='imagenet', include_top=False)
